    ...
    describe('new', function() {
        ...
        it('should create an instance of a subclass if the type property matches the alias', function() {
            ...
            var items = [{
                ...
                id: 2,
                __iguana_type: 'item_type_2'
            }];

            //Mocking out the adapter to load up the first item.
            Item.adapter().expect('show', 'items', 1, {
                result: [items[0]]
            });
            ...
            Item.adapter().expect('show', 'items', 2, {
                result: [items[1]]
            });
        ...
        it('should work with a lazy-loaded class', function() {
            var mockClass = jasmine.createSpy('mockClass');
            mockClass.inheritsFrom = function() {
                return true;
            };
